...
RULES: list[tuple[re.Pattern, str]] = [
    ...
    # ── Itambaraçá ────────────────────────────────────────────────────────────
    (_r(r'^ITCA'), 'Itambaraçá'),
    (_r(r'^ITMCA'), 'Itambaraçá'),
    (_r(r'^ITAMBARACA'), 'Itambaraçá'),
    (_r(r'^ITANBARACA'), 'Itambaraçá'),
    (_r(r'^ATANBARACA'), 'Itambaraçá'),
    (_r(r'^ITABARACA'), 'Itambaraçá'),
    (_r(r'^ITBCA'), 'Itambaraçá'),
    (_r(r'^ITBANCA'), 'Itambaraçá'),
    (_r(r'^ITBRACA'), 'Itambaraçá'),
    (_r(r'^ITMBCA'), 'Itambaraçá'),
    (_r(r'^ITMBARACA'), 'Itambaraçá'),
    (_r(r'^ITMBC'), 'Itambaraçá'),
    (_r(r'^ITAMCA'), 'Itambaraçá'),
    (_r(r'^ITANCA'), 'Itambaraçá'),
    (_r(r'^ITBC$'), 'Itambaraçá'),
    (_r(r'^ITC$'), 'Itambaraçá'),
    (_r(r'^ITB$'), 'Itambaraçá'),
    (_r(r'^INTCA'), 'Itambaraçá'),
    (_r(r'^UTCA$'), 'Itambaraçá'),
    (_r(r'^RTCA$'), 'Itambaraçá'),
    (_r(r'^ITAC$'), 'Itambaraçá'),
    (_r(r'^ITACS$'), 'Itambaraçá'),
    (_r(r'^ITCS$'), 'Itambaraçá'),
    (_r(r'^ITEN$'), 'Itambaraçá'),
    (_r(r'^1TAMBARACA'), 'Itambaraçá'),
    (_r(r'^\.ITCA'), 'Itambaraçá'),
    (_r(r'^ITACA$'), 'Itambaraçá'),
    (_r(r'^TCA$'), 'Itambaraçá'),
    (_r(r'^ITCAA'), 'Itambaraçá'),
    ...
    (_r(r'^.+\s+ITCA\.?$'), 'Itambaraçá'),
    (_r(r'^.+\s+ITAMBARACA$'), 'Itambaraçá'),
